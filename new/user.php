...
<hr>
<br><PRE><table>
<tr><td>   <form action="use.php?name=$c" method="post" name="mf2">
<br>NAME..........<input type="text" name="name" value='.$c.' /><br>
<br>AGE...........<input type="text" name="age" value='.$d.'><br>
<br>GENDER........<input type="text" name="gender" value='.$row["gender"].'><br>
<br>DOB...........<input type="text" name="dob" value='.$row["dob"].'><br>
...
</td><td><br>PHONE.........<input type="text" name="phone" value='.$row["phone"].'><br>
...
<br>PASSWORD......<input type="text" name="password" value='.$row["password"].'><br>
<br><br><input type="submit" value="SUBMIT"/></td></tr></table>
</form></PRE>';
echo'</body></html>';
}
?>